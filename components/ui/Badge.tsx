...
const STATUS_STYLES: Record<ClaimStatus, string> = {
  ...
  // Phase 2.6 — quality / technical / PM stages.
  under_technical_review:       'bg-[#EDE7F6] text-[#502C7C]',
  returned_by_technical:        'bg-[#FAEEE8] text-[#C05728]',
  under_quality_review:         'bg-[#FFF8E0] text-[#C46A00]',
  returned_by_quality:          'bg-[#FAEEE8] text-[#C05728]',
  under_project_manager_review: 'bg-[#E0F4F3] text-[#00796B]',
  returned_by_project_manager:  'bg-[#FAEEE8] text-[#C05728]',
  pending_director_approval:    'bg-[#E8F4F4] text-[#045859]',
  returned_by_final_approver:   'bg-[#FAEEE8] text-[#C05728]',

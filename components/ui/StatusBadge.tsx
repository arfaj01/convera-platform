...
const CLAIM_TONE: Record<ClaimStatus, StatusTone> = {
  ...
  under_technical_review:        'review',
  returned_by_technical:         'warning',
  under_quality_review:          'progress',
  returned_by_quality:           'warning',
  under_project_manager_review:  'progress',
  returned_by_project_manager:   'warning',
  returned_by_final_approver:    'warning',

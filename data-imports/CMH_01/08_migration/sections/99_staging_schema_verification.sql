-- ════════════════════════════════════════════════════════════════════
--  CMH_01 STAGING — Section 99 — Verification
--  Source seq      : verification
--  Source migration: data-imports/CMH_01/08_migration/staging_schema_verification.sql
--  Purpose         : Confirm that all sections applied cleanly. Multiple SELECTs return row output for the operator to paste back.
--  Run order       : LAST — only after 00 → 48 all succeed.
...
--  Row output IS expected for verification SELECTs.
--  On error: STOP and report; this means a prior section did not commit as expected.
-- ════════════════════════════════════════════════════════════════════

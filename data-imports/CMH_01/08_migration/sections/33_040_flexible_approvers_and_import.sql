-- ════════════════════════════════════════════════════════════════════
--  CMH_01 STAGING — Section 33 — MIGRATION
--  Source seq      : 040
--  Source migration: migrations/040_flexible_approvers_and_import.sql
--  Purpose         : flexible approvers (newer)
--  Run order       : STEP 33 of 48 (after STEP 32, before STEP 34).

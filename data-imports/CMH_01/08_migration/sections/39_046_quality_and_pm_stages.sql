-- ════════════════════════════════════════════════════════════════════
--  CMH_01 STAGING — Section 39 — MIGRATION
--  Source seq      : 046
--  Source migration: migrations/046_quality_and_pm_stages.sql
--  Purpose         : quality + project_manager workflow stages
--  Run order       : STEP 39 of 48 (after STEP 38, before STEP 40).

-- ════════════════════════════════════════════════════════════════════
--  CMH_01 STAGING — Section 43 — MIGRATION
--  Source seq      : 050
--  Source migration: migrations/050_fix_claim_rpc_claim_type_cast.sql
--  Purpose         : RPC claim_type cast removal
--  Run order       : STEP 43 of 48 (after STEP 42, before STEP 44).

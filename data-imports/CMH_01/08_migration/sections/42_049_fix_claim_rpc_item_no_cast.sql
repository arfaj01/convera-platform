-- ════════════════════════════════════════════════════════════════════
--  CMH_01 STAGING — Section 42 — MIGRATION
--  Source seq      : 049
--  Source migration: migrations/049_fix_claim_rpc_item_no_cast.sql
--  Purpose         : RPC item_no cast fix
--  Run order       : STEP 42 of 48 (after STEP 41, before STEP 43).

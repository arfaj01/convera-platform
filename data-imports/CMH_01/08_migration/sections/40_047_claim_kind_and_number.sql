-- ════════════════════════════════════════════════════════════════════
--  CMH_01 STAGING — Section 40 — MIGRATION
--  Source seq      : 047
--  Source migration: migrations/047_claim_kind_and_number.sql
--  Purpose         : claim_kind, claim_number, partial unique
--  Run order       : STEP 40 of 48 (after STEP 39, before STEP 41).

-- ════════════════════════════════════════════════════════════════════
--  CMH_01 STAGING — Section 34 — MIGRATION
--  Source seq      : 041
--  Source migration: migrations/041_final_approver_role.sql
--  Purpose         : final_approver role (newer)
--  Run order       : STEP 34 of 48 (after STEP 33, before STEP 35).

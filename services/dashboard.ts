...
const STATUS_META: Record<ClaimStatus, { label: string; color: string; order: number }> = {
  ...
  under_technical_review:        { label: 'مراجعة الوحدة الفنية',     color: '#502C7C', order: 7.1 },
  returned_by_technical:         { label: 'مُرجَّعة من الوحدة الفنية', color: '#C05728', order: 7.2 },
  under_quality_review:          { label: 'مراجعة وحدة الجودة',       color: '#FFC845', order: 7.3 },
  returned_by_quality:           { label: 'مُرجَّعة من وحدة الجودة',  color: '#C05728', order: 7.4 },
  under_project_manager_review:  { label: 'مراجعة مدير المشروع',       color: '#00A79D', order: 7.5 },
  returned_by_project_manager:   { label: 'مُرجَّعة من مدير المشروع', color: '#C05728', order: 7.6 },
  returned_by_final_approver:    { label: 'مُرجَّعة من الاعتماد',     color: '#C05728', order: 8.5 },
